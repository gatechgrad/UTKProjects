...
Begin VB.Form frmReplacement 
   ...
   Begin VB.Frame Frame2 
      ...
      Top             =   2520
      Width           =   6495
      Begin VB.CommandButton butChalSelect 
         Caption         =   "Select"
         Height          =   375
         Left            =   4440
         TabIndex        =   16
   ...
   Begin VB.Frame Frame1 
      ...
      Top             =   360
      Width           =   6495
      Begin VB.CommandButton butDefSelect 
         Caption         =   "Select"
         Height          =   375
         Left            =   3960
         TabIndex        =   15
...
Private Sub butChalSelect_Click()
    frmExpectedServiceLife.Show

End Sub

Private Sub butDefSelect_Click()
    frmExpectedServiceLife.Show
