/**
 * AddWidget.java - displays four buttons with arrows that allow
 *                  the user to add rows and columns 
 *
...
public class AddWidget extends JComponent implements MouseListener {
  ...
  /**
   * setDisabled - sets the widget to disabled
   */
  ...
  /**
   * paintComponent - draws the widget
   */
  ...
  /**
   * mousePressed - handles mouse presses
   */
   ...
   * mouseExited - required by MouseListener
   */
  ...
  /**
   * buttonClicked - determines which button was clicked and
