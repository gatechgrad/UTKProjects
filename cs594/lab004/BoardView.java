 ...
 JOptionPane.INFORMATION_MESSAGE );
  ...
  public void mousePressed(MouseEvent e) { 
   ...
   if (e.getModifiers() == InputEvent.BUTTON1_MASK) {
    ...
    if ((pntCell.x == theSB.getBoardData().getPlayer().getPlayerLocX()) &&
    ...
    } else if ((pntCell.x == theSB.getBoardData().getPlayer().getPlayerLocX() - 1) &&
        (pntCell.y == theSB.getBoardData().getPlayer().getPlayerLocY()) 
       ) {
    ...
    } else if ((pntCell.x == theSB.getBoardData().getPlayer().getPlayerLocX()) &&
        (pntCell.y == theSB.getBoardData().getPlayer().getPlayerLocY() + 1) 
       ) {
      ...
      iTurns = theSB.getBoardData().getTurnsToMove(
                      theSB.getBoardData().getPlayer().getPlayerLocX(),
                      theSB.getBoardData().getPlayer().getPlayerLocY(),
                      pntCell.x, pntCell.y);
      if (iTurns > 0) {
        theSB.getBoardData().addTurns(iTurns);

        theSB.getBoardData().addUndoHistory(
           new UndoHistory(theSB.getBoardData().getPlayer().getPlayerLocX() - pntCell.x,
           theSB.getBoardData().getPlayer().getPlayerLocY() - pntCell.y, 
           null, iTurns));

        theSB.getBoardData().getPlayer().setPlayerLocation(pntCell.x, pntCell.y);
        theSB.repaintViews();
      } else {
        cantMove();
      }
