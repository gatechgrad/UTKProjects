...
public class sokoban {
  ...
  private void setupWindow() {
    ...
    theFrame.getContentPane().add(theBoardView, BorderLayout.CENTER);
    theFrame.getContentPane().add(theTextBoardView, BorderLayout.EAST);
  ...
  /**
   * repaintViews - tells all of the views to repaint themselves
   */
  ...
  public void setViewsWallColor() {
    ...
    c = jcc.showDialog(theBoardView, "Choose Wall Color", Color.white);
  ...
  public void setViewsGoalColor() {
    ...
    jcc = new JColorChooser();
    c = jcc.showDialog(theBoardView, "Choose Goal (Shaded) Color", Color.white);
  ...
  public void setViewsBlankColor() {
    ...
    jcc = new JColorChooser();
    c = jcc.showDialog(theBoardView, "Choose Blank Color", Color.white);
