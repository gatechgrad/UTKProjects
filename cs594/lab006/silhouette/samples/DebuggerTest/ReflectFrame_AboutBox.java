...
public class ReflectFrame_AboutBox extends JDialog implements ActionListener {
  ...
  String product = "Reflect1";
  String version = "1.0";
  String copyright = "Copyright (c) rg";
  String comments = "";
  public ReflectFrame_AboutBox(Frame parent) {
    super(parent);
