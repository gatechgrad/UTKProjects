...
/** 
 * Attaches the first endpoint to one of the eight compass points on
 ...
 * object.
 *
 * If the attach object is bigger than or equal in size to 
 * the reference object, then the
...
public class attachPt1ToNearestCompassPt extends attachPtToNearestCompassPt {
     ...
     **/
    public attachPt1ToNearestCompassPt(Object obj, Object fromObj) {
	super(obj, fromObj);
    }
	...
	objToSet.setX1(attachPt.getX());
	objToSet.setY1(attachPt.getY());
    }
    
    public String toString () {
	return "constraint attachPt1ToNearestCompassPt";
    }
}
