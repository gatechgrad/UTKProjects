...
public class alignBefore extends constraint {
     ...
     **/
    public alignBefore(SilShape obj) {
     ...
     * object
     **/
    public alignBefore(SilShape obj, int offset) {
	...
	objToSet.setRight(referenceObj.getLeft() - displacement);
    }
}
