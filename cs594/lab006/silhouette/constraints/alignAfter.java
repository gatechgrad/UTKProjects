...
public class alignAfter extends constraint {
     ...
     **/
    public alignAfter(SilShape obj) {
     ...
     * object
     **/
    public alignAfter(SilShape obj, int offset) {
	...
	objToSet.setLeft(referenceObj.getRight() + displacement);
    }
}
