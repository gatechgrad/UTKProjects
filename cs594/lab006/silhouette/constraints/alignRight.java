...
/**
 * Right align an object with respect to a reference object. 
 **/

public class alignRight extends constraint {
     ...
     **/
    public alignRight(Object obj, int offset) {
	...
	if (objToSet.getParent() == referenceObj) {
	    objToSet.setRight(referenceObj.getWidth() + displacement);
	}
	// if the reference object is not the parent of this object, use
	// absolute coordinates to align the objects
	else {
	    objToSet.setRight(referenceObj.getRight() + displacement);
	}
    }
}
