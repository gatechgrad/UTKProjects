...
/** 
 * attach the first endpoint of the line to the point where the line 
...
public class attachPt1ToClippedCenterPt extends constraint {
     ...
     **/
    public attachPt1ToClippedCenterPt(Object obj, Object fromObj) {
	...
	((LineShape)self).setX1(intersectPt.getX());
	((LineShape)self).setY1(intersectPt.getY());
    }
