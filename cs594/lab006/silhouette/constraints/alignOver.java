...
public class alignOver extends constraint {
     ...
     * object
     **/
    public alignOver(SilShape obj, int offset) {
	...
	objToSet.setBottom(referenceObj.getTop() - displacement);
    }
}
