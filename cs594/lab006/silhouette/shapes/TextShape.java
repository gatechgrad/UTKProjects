...
/*  public SilProperty getTextProperty() {
  ...
  public SilProperty getFontProperty() {
	...
	System.out.println("Warning for " + this + " : You cannot explicitly set the width of a TextShape");
	...
	System.out.println("Warning for " + this + " : You cannot explicitly set the height of a TextShape");
