...
class ThermometerApplication {
  ...
  private RotateWidget theRotateWidget;
  ...
  public ThermometerApplication(int i1, int i2, int i3) {
    ...
    theRotateWidget = new RotateWidget(this);
    setupWindow();
  ...
  private void setupWindow() {
    ...
    pnlTop.add(theRotateWidget);
    theFrame.getContentPane().add(pnlTop, BorderLayout.NORTH);
    theFrame.getContentPane().add(theThermometer, BorderLayout.CENTER);
  ...
  public static void main(String args[]) {
    ...
    System.out.println("Please Read:  Scaling doesn't seem to always work correctly, so please try it last.  Thank you.");
